#!/usr/bin/env python3
"""
Filename: run_createhotWordLexiconUnigram (method 1+2)
...
def methodID_1(args):
  ...
  # Lets read the hot word first
    ...
    if str(args.whichMethod) == '4':
        print('no change in count')
        pass
        #sqrt root the count
        #print('Square count of Syllabe based')
        #myMasterCount.SquareCount()
        #myHotWordCount.SquareCount()
